 ...
 * Use the [RegistrationScreenFragment.newInstance] factory method to
...
class RegistrationScreenFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegistrationScreenFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegistrationScreenFragment().apply {
